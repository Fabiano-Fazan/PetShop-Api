...
public class ProductCategoryService {
    ...
    private void canDelete(ProductCategory productCategory) {
        if (productRepository.existsByCategory(productCategory)) {
            throw new BusinessException("Cannot delete this category because it is being used by some products");
        }
    }
}
